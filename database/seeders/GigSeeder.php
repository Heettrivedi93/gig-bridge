    ...
    public function run(): void
    {
        ...
        $definitions = [
            [
                ...
                'packages' => [
                    'basic' => ['Starter logo', '1 logo concept with transparent export.', 35, 2, 2],
                    'standard' => ['Business logo kit', '2 concepts with color variations and brand sheet.', 75, 4, 3],
                    'premium' => ['Full brand identity', '3 concepts, brand guide, social assets, and source files.', 150, 6, 5],
                ],
            ],
            [
                ...
                'packages' => [
                    'basic' => ['Single-page build', 'Responsive one-page website with 3 sections.', 120, 3, 2],
                    'standard' => ['Marketing site', 'Responsive website with up to 6 sections and contact form.', 240, 5, 3],
                    'premium' => ['Conversion site', 'Full landing experience with animations and CMS-ready sections.', 420, 7, 5],
                ],
            ],
            [
                'category' => $marketing,
                ...
                'packages' => [
                    'basic' => ['SEO starter', 'Optimization for up to 5 pages with keyword suggestions.', 60, 3, 1],
                    'standard' => ['SEO growth', 'Optimization for 10 pages plus content recommendations.', 140, 5, 2],
                    'premium' => ['SEO authority', 'Advanced optimization, audit report, and priority roadmap.', 260, 7, 3],
                ],
            ],
            [
                'category' => $writing,
                ...
                'packages' => [
                    'basic' => ['Homepage copy', 'Homepage headline and 3 conversion sections.', 55, 2, 1],
                    'standard' => ['Sales page copy', 'Full website page copy for one service or offer.', 130, 4, 2],
                    'premium' => ['Brand messaging set', 'Website copy plus messaging guide and CTA variants.', 240, 6, 3],
                ],
            ],
            [
                'category' => $video,
                ...
                'packages' => [
                    'basic' => ['3 short videos', 'Up to 3 edited short videos with captions.', 45, 2, 1],
                    'standard' => ['8 short videos', 'Batch editing with hooks, captions, and music sync.', 120, 4, 2],
                    'premium' => ['15 short videos', 'High-volume short-form package with creative pacing.', 220, 6, 3],
                ],
            ],
            [
                'category' => $graphics,
                ...
                'packages' => [
                    'basic' => ['Mini identity', 'Logo plus typography and color palette.', 80, 3, 2],
                    'standard' => ['Brand kit', 'Logo suite, palette, typography, and mini guide.', 180, 5, 3],
                    'premium' => ['Full identity', 'Full brand kit with social templates and guide.', 320, 7, 4],
                ],
            ],
            [
                'category' => $programming,
                ...
                'packages' => [
                    'basic' => ['1 bug fix', 'Fix one isolated bug or UI issue.', 40, 1, 1],
                    'standard' => ['3 bug fixes', 'Resolve multiple issues across one project area.', 110, 3, 2],
                    'premium' => ['Deep fix sprint', 'Priority debugging pass for complex app issues.', 240, 5, 3],
                ],
            ],
            [
                'category' => $marketing,
                ...
                'packages' => [
                    'basic' => ['Mini audit', 'Website review with quick fixes and summary.', 50, 2, 1],
                    'standard' => ['Growth audit', 'Detailed audit with issues and recommendations.', 125, 4, 2],
                    'premium' => ['SEO roadmap', 'Audit, action plan, and implementation priority matrix.', 240, 6, 3],
                ],
            ],
            [
                'category' => $writing,
                ...
                'packages' => [
                    'basic' => ['1 article', 'One optimized article up to 1000 words.', 35, 2, 1],
                    'standard' => ['3 articles', 'Three optimized blog posts with metadata.', 95, 4, 2],
                    'premium' => ['Content bundle', 'Five blog posts with internal-link suggestions.', 170, 6, 3],
                ],
            ],
            [
                'category' => $video,
                ...
                'packages' => [
                    'basic' => ['Single edit', 'Edit one video up to 8 minutes.', 70, 3, 1],
                    'standard' => ['Channel bundle', 'Edit two polished videos with captions.', 160, 5, 2],
                    'premium' => ['Creator pack', 'Edit four videos with style consistency and polish.', 320, 7, 3],
                ],
            ],
            [
                'category' => $graphics,
                ...
                'packages' => [
                    'basic' => ['5 posts', 'Five branded post designs for one campaign.', 30, 2, 1],
                    'standard' => ['12 posts', 'Twelve branded post templates with resizing.', 75, 4, 2],
                    'premium' => ['20 posts', 'Full monthly visual content kit with campaign consistency.', 140, 6, 3],
                ],
            ],
            [
                'category' => $programming,
                ...
                'packages' => [
                    'basic' => ['Starter site', 'Up to 3 sections and mobile responsiveness.', 150, 4, 2],
                    'standard' => ['Business site', 'Full multi-section site with inquiry form.', 320, 6, 3],
                    'premium' => ['Premium site', 'Advanced layout, animations, and conversion polish.', 550, 8, 4],
                ],
            ],
            [
                'category' => $marketing,
                ...
                'packages' => [
                    'basic' => ['Profile cleanup', 'Google Business Profile optimization basics.', 45, 2, 1],
                    'standard' => ['Local growth', 'Profile optimization plus competitor review.', 110, 4, 2],
                    'premium' => ['Local authority', 'Full local SEO package with citation plan.', 210, 6, 3],
                ],
            ],
            [
                'category' => $writing,
                ...
                'packages' => [
                    'basic' => ['5 products', 'Descriptions for five products.', 30, 2, 1],
                    'standard' => ['15 products', 'Descriptions for fifteen products with tone consistency.', 85, 4, 2],
                    'premium' => ['30 products', 'Large product-copy batch with category messaging support.', 160, 6, 3],
                ],
            ],
            [
                'category' => $video,
                ...
                'packages' => [
                    'basic' => ['15-second promo', 'Short promotional video edit for ads or socials.', 50, 2, 1],
                    'standard' => ['30-second promo', 'Polished ad or promo video with captions.', 120, 4, 2],
                    'premium' => ['60-second campaign promo', 'Longer promo edit with multiple format exports.', 230, 6, 3],
                ],
            ],
        ];
